...
export default async function Home() {
  ...
  return <div className={styles.page}>
    <header className={styles.nav}>
      <Link href="/" className="brand-lockup"><img src="/logo.jpg" alt="SAFARIBOYZ" className="brand-logo" style={{ width: 36, height: 36, borderRadius: '50%', objectFit: 'cover', boxShadow: '0 2px 8px rgba(189,123,28,0.3)' }} /></Link>
    ...
    <main>
      <section className={styles.hero} id="discover">
        ...
        <div className={styles.visual} aria-hidden="true"><img src="/logo.jpg" alt="SAFARIBOYZ Hero" className={styles.heroImg} style={{ borderRadius: '50%', objectFit: 'cover' }} /><div className={`${styles.floatCard} ${styles.topCard}`}><span>Secure wallet</span><strong>Private by design</strong></div><div className={`${styles.floatCard} ${styles.bottomCard}`}><span>Always available</span><strong>24/7 bot access</strong></div></div>
      </section>
